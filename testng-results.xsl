...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template name="powered-by">
        <div style="margin-top: 15px; color: gray; text-align: center; font-size: 12px;">
            G7s Automation Test.  
            <a href="http://172.16.1.23:8080/job/G7s_Automation_Prod/ws/G7sAutomation/test-output/index1.html" style="color: #8888aa;" target="_blank">
                See details log in Jenkins.
            </a>
        </div>
    </xsl:template>
